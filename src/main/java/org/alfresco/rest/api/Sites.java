...
public interface Sites
{
    ...
    CollectionWithPagingInfo<SiteGroup> getSiteGroupMembership(String siteId, Parameters parameters);
    ...
    void deleteSiteGroupMembership(String groupId, String siteId);
